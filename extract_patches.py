...
#         print self.scans_train
#         for i in range(len( self.scans_train)):
#             if i%10==0:
#                 print('iteration [{}]'.format(i))

#             flair = glob( self.scans_train[i] +  '/*Flair*/*.mha')#_flair.nii.gz')
#             t2 = glob( self.scans_train[i] + '/*_T2*/*.mha')
#             gt = glob( self.scans_train[i] + '/*more*/*.mha')
#             t1 = glob( self.scans_train[i] + '/**/*T1*.mha')
#             t1c = glob( self.scans_train[i] + '/*T1*/*_n.mha')
...
#                 continue
#             scans = [flair[0], t1s[0], t1s[1], t2[0], gt[0]]
...
#     path_HGG = glob('/home/priyam/Downloads/Brats2017/Brats17TrainingData/HGG/**')
#     path_LGG = glob('/home/priyam/Downloads/Brats2017/Brats17TrainingData/LGG/**')
#     path_all=path_HGG+path_LGG
...
#     path_HGG = glob(os.path.join(current_dir, 'BRATS2015_', 'training', 'HGG', '*'))
#     path_LGG = glob(os.path.join(current_dir, 'BRATS2015_', 'training', 'LGG', '*'))
#     path_all = path_HGG + path_LGG
...
#     start=0
#     end=5
#     #for validation set start = 6 and end = 9
...
#     #for validation
#     #np.save( "x_valid",Patches.astype(np.float32) )
